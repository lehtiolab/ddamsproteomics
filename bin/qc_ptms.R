...
svg('ptmpsmfeats', width=width, height=nrsets+2)
  print(ggplot(set_amount_psms) +
    ...
    coord_flip() + ylab('# PSMs with labile PTM') + theme_bw() + theme(axis.title=element_text(size=15), axis.text=element_text(size=10), axis.title.y=element_blank(), legend.text=element_text(size=10), legend.title=element_blank(), legend.position='top', plot.title=element_text(size=15))
  )
dev.off()
...
svg('ptmpepfeats', width=width, height=nrsets+2)
  print(ggplot(pepnums) +
    ...
    coord_flip() + ylab('# peptides with labile PTM') + theme_bw() + theme(axis.title=element_text(size=15), axis.text=element_text(size=10), axis.title.y=element_blank(), legend.text=element_text(size=10), legend.title=element_blank(), legend.position='top', plot.title=element_text(size=15))
  )
dev.off()
